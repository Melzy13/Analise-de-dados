...
"""
# RESOLUCAO
filtro = df["nome_aluno"] == "Melissa Yano Lima"
df.loc[filtro,:]
...
"""
# RESOLUCAO
filtro = df["nome_alunos"].str.contains("^[M]")
df.loc[filtro,:]
...
# r"^[ABC]"
# RESOLUCAO
filtro = df["nome_alunos"].str.contains("^[ABC]")
df.loc[filtro,:]
...
# r"^(Ana|Maria)"
# RESOLUCAO
filtro = df["nome_alunos"].str.contains("^(Ana|Maria)", case=False)
df.loc[filtro,:]
...
# r"^[A-Za-z ]+$"
# RESOLUCAO
filtro = df["nome_alunos"].str.contains("[A-Z]+", case=False)
df.loc[filtro,:]
...
"""
# RESOLUCAO
filtro = df["nome_alunos"].str.contains("^[A-Z]+ [A-Z]+ (Souza|Lima|Rocha)$", case=False)
df.loc[filtro,:]
